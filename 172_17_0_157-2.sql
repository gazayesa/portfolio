...
--
-- Host: 172.17.0.157
-- Generation Time: Dec 13, 2016 at 09:21 PM
...
--
-- Database: `db1434665_joomla`
--

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_assets`
--

CREATE TABLE IF NOT EXISTS `kts0j_assets` (
...
--
-- Dumping data for table `kts0j_assets`
--

INSERT INTO `kts0j_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(55, 1, 109, 110, 1, 'com_sppagebuilder', 'SP Page Builder', '{}'),
(56, 18, 74, 75, 2, 'com_modules.module.87', 'SP Page Builder', '{}'),
(57, 18, 76, 77, 2, 'com_modules.module.88', 'SP Page Builder Admin Menu', '{}'),
(58, 16, 38, 39, 2, 'com_menus.menu.2', 'my menu', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_associations`
--

CREATE TABLE IF NOT EXISTS `kts0j_associations` (
...
--
-- Table structure for table `kts0j_banner_clients`
--

CREATE TABLE IF NOT EXISTS `kts0j_banner_clients` (
...
--
-- Table structure for table `kts0j_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `kts0j_banner_tracks` (
...
--
-- Table structure for table `kts0j_banners`
--

CREATE TABLE IF NOT EXISTS `kts0j_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `kts0j_categories`
--

CREATE TABLE IF NOT EXISTS `kts0j_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `kts0j_categories`
--

INSERT INTO `kts0j_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 423, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 423, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 423, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 423, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 423, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 423, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_contact_details`
--

CREATE TABLE IF NOT EXISTS `kts0j_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `kts0j_content`
--

CREATE TABLE IF NOT EXISTS `kts0j_content` (
...
--
-- Table structure for table `kts0j_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `kts0j_content_frontpage` (
...
--
-- Table structure for table `kts0j_content_rating`
--

CREATE TABLE IF NOT EXISTS `kts0j_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `kts0j_content_types`
--

CREATE TABLE IF NOT EXISTS `kts0j_content_types` (
...
--
-- Dumping data for table `kts0j_content_types`
--

INSERT INTO `kts0j_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `kts0j_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `kts0j_contentitem_tag_map` (
...
--
-- Table structure for table `kts0j_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `kts0j_core_log_searches` (
...
--
-- Table structure for table `kts0j_extensions`
--

CREATE TABLE IF NOT EXISTS `kts0j_extensions` (
...
--
-- Dumping data for table `kts0j_extensions`
--

INSERT INTO `kts0j_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"cf1f6a8a4c12541cf534ee745baf2ade"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1481641609}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":2,"lastrun":1481643059,"unique_id":"121447f66e5b12d0d361c2b607d83fd2c191a8d3","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `kts0j_finder_links`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links` (
...
--
-- Table structure for table `kts0j_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_terms0` (
...
--
-- Table structure for table `kts0j_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `kts0j_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `kts0j_finder_taxonomy`
--

INSERT INTO `kts0j_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `kts0j_finder_terms`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_terms` (
...
--
-- Table structure for table `kts0j_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `kts0j_finder_terms_common`
--

INSERT INTO `kts0j_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `kts0j_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `kts0j_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `kts0j_finder_types`
--

CREATE TABLE IF NOT EXISTS `kts0j_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `kts0j_languages`
--

CREATE TABLE IF NOT EXISTS `kts0j_languages` (
...
--
-- Dumping data for table `kts0j_languages`
--

INSERT INTO `kts0j_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_menu`
--

CREATE TABLE IF NOT EXISTS `kts0j_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `kts0j_menu`
--

INSERT INTO `kts0j_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'main', 'COM_SPPAGEBUILDER', 'com-sppagebuilder', '', 'com-sppagebuilder', 'index.php?option=com_sppagebuilder', 'component', 0, 1, 1, 10005, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 43, 44, 0, '', 1),
(103, 'nav', 'About Me', 'about-me', '', 'about-me', 'index.php?option=com_sppagebuilder&view=page&id=1', 'component', 1, 1, 1, 10005, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"Home","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0,"menulayout":"{\\"width\\":600,\\"menuItem\\":1,\\"menuAlign\\":\\"right\\",\\"layout\\":[{\\"type\\":\\"row\\",\\"attr\\":[{\\"type\\":\\"column\\",\\"colGrid\\":12,\\"menuParentId\\":\\"103\\",\\"moduleId\\":\\"\\"}]}]}","megamenu":"0","showmenutitle":"1","icon":"","class":"","enable_page_title":"0","page_title_alt":"","page_subtitle":"","page_title_bg_color":"","page_title_bg_image":""}', 45, 46, 1, '*', 0),
(104, 'nav', 'Video', 'video', '', 'video', 'index.php?option=com_sppagebuilder&view=page&id=2', 'component', 1, 1, 1, 10005, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"Video","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0,"menulayout":"{\\"width\\":600,\\"menuItem\\":1,\\"menuAlign\\":\\"right\\",\\"layout\\":[{\\"type\\":\\"row\\",\\"attr\\":[{\\"type\\":\\"column\\",\\"colGrid\\":12,\\"menuParentId\\":\\"104\\",\\"moduleId\\":\\"\\"}]}]}","megamenu":"0","showmenutitle":"1","icon":"","class":"","enable_page_title":"0","page_title_alt":"","page_subtitle":"","page_title_bg_color":"","page_title_bg_image":""}', 47, 48, 0, '*', 0),
(105, 'nav', 'Graphic Design', 'graphic-design', '', 'graphic-design', 'index.php?option=com_sppagebuilder&view=page&id=4', 'component', 1, 1, 1, 10005, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0,"dropdown_position":"right","showmenutitle":"1","icon":"","class":"","enable_page_title":"0","page_title_alt":"","page_subtitle":"","page_title_bg_color":"","page_title_bg_image":""}', 49, 50, 0, '*', 0),
(106, 'nav', 'Contact Me', 'contact-me', '', 'contact-me', 'index.php?option=com_sppagebuilder&view=page&id=3', 'component', 1, 1, 1, 10005, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"menu_show":1,"page_title":"","show_page_heading":"","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0,"dropdown_position":"right","showmenutitle":"1","icon":"","class":"","enable_page_title":"0","page_title_alt":"","page_subtitle":"","page_title_bg_color":"","page_title_bg_image":""}', 51, 52, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_menu_types`
--

CREATE TABLE IF NOT EXISTS `kts0j_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(11) NOT NULL,
...
--
-- Dumping data for table `kts0j_menu_types`
--

INSERT INTO `kts0j_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `kts0j_messages`
--

CREATE TABLE IF NOT EXISTS `kts0j_messages` (
...
--
-- Table structure for table `kts0j_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `kts0j_messages_cfg` (
...
--
-- Table structure for table `kts0j_modules`
--

CREATE TABLE IF NOT EXISTS `kts0j_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `kts0j_modules`
--

INSERT INTO `kts0j_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `kts0j_modules_menu`
--

CREATE TABLE IF NOT EXISTS `kts0j_modules_menu` (
...
--
-- Dumping data for table `kts0j_modules_menu`
--

INSERT INTO `kts0j_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `kts0j_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `kts0j_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `kts0j_overrider`
--

CREATE TABLE IF NOT EXISTS `kts0j_overrider` (
...
--
-- Table structure for table `kts0j_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `kts0j_postinstall_messages` (
...
--
-- Dumping data for table `kts0j_postinstall_messages`
--

INSERT INTO `kts0j_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `kts0j_redirect_links`
--

CREATE TABLE IF NOT EXISTS `kts0j_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `kts0j_schemas`
--

CREATE TABLE IF NOT EXISTS `kts0j_schemas` (
...
--
-- Dumping data for table `kts0j_schemas`
--

INSERT INTO `kts0j_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.6.3-2016-08-16'),
(10005, '2.0-2016-11-04');

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_session`
--

CREATE TABLE IF NOT EXISTS `kts0j_session` (
...
--
-- Table structure for table `kts0j_spmedia`
--

CREATE TABLE IF NOT EXISTS `kts0j_spmedia` (
...
--
-- Dumping data for table `kts0j_spmedia`
--

INSERT INTO `kts0j_spmedia` (`id`, `title`, `path`, `thumb`, `alt`, `caption`, `description`, `type`, `extension`, `created_on`, `created_by`, `modified_on`, `modified_by`) VALUES
(1, '141_phoenix-park-dublin', 'images/2016/12/13/141_phoenix-park-dublin.jpg', 'images/2016/12/13/_spmedia_thumbs/141_phoenix-park-dublin.jpg', '141_phoenix-park-dublin', '', '', 'image', 'com_sppagebuilder', '2016-12-13 15:30:28', 423, '0000-00-00 00:00:00', 0),
(2, 'screen-shot-2016-12-13-at-16.53.55', 'images/2016/12/13/screen-shot-2016-12-13-at-16.53.55.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-16.53.55.png', 'screen-shot-2016-12-13-at-16.53.55', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:52', 423, '0000-00-00 00:00:00', 0),
(3, 'screen-shot-2016-12-13-at-16.53.48', 'images/2016/12/13/screen-shot-2016-12-13-at-16.53.48.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-16.53.48.png', 'screen-shot-2016-12-13-at-16.53.48', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:52', 423, '0000-00-00 00:00:00', 0),
(4, 'screen-shot-2016-12-13-at-16.53.39', 'images/2016/12/13/screen-shot-2016-12-13-at-16.53.39.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-16.53.39.png', 'screen-shot-2016-12-13-at-16.53.39', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:53', 423, '0000-00-00 00:00:00', 0),
(5, 'screen-shot-2016-12-13-at-16.53.26', 'images/2016/12/13/screen-shot-2016-12-13-at-16.53.26.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-16.53.26.png', 'screen-shot-2016-12-13-at-16.53.26', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:53', 423, '0000-00-00 00:00:00', 0),
(6, 'screen-shot-2016-12-13-at-16.53.03', 'images/2016/12/13/screen-shot-2016-12-13-at-16.53.03.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-16.53.03.png', 'screen-shot-2016-12-13-at-16.53.03', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:54', 423, '0000-00-00 00:00:00', 0),
(7, 'screen-shot-2016-12-13-at-16.52.53', 'images/2016/12/13/screen-shot-2016-12-13-at-16.52.53.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-16.52.53.png', 'screen-shot-2016-12-13-at-16.52.53', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:56', 423, '0000-00-00 00:00:00', 0),
(8, 'screen-shot-2016-12-13-at-16.53.10', 'images/2016/12/13/screen-shot-2016-12-13-at-16.53.10.png', '', 'screen-shot-2016-12-13-at-16.53.10', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:57', 423, '0000-00-00 00:00:00', 0),
(9, 'screen-shot-2016-12-13-at-16.52.43', 'images/2016/12/13/screen-shot-2016-12-13-at-16.52.43.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-16.52.43.png', 'screen-shot-2016-12-13-at-16.52.43', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:56', 423, '0000-00-00 00:00:00', 0),
(10, 'screen-shot-2016-12-13-at-16.53.19', 'images/2016/12/13/screen-shot-2016-12-13-at-16.53.19.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-16.53.19.png', 'screen-shot-2016-12-13-at-16.53.19', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:57', 423, '0000-00-00 00:00:00', 0),
(11, 'screen-shot-2016-12-13-at-16.52.30', 'images/2016/12/13/screen-shot-2016-12-13-at-16.52.30.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-16.52.30.png', 'screen-shot-2016-12-13-at-16.52.30', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:58', 423, '0000-00-00 00:00:00', 0),
(12, 'screen-shot-2016-12-13-at-16.52.20', 'images/2016/12/13/screen-shot-2016-12-13-at-16.52.20.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-16.52.20.png', 'screen-shot-2016-12-13-at-16.52.20', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:59', 423, '0000-00-00 00:00:00', 0),
(13, 'screen-shot-2016-12-13-at-16.52.29', 'images/2016/12/13/screen-shot-2016-12-13-at-16.52.29.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-16.52.29.png', 'screen-shot-2016-12-13-at-16.52.29', '', '', 'image', 'com_sppagebuilder', '2016-12-13 16:55:58', 423, '0000-00-00 00:00:00', 0),
(14, 'img_3275', 'images/2016/12/13/img_3275.png', 'images/2016/12/13/_spmedia_thumbs/img_3275.png', 'img_3275', '', '', 'image', 'com_sppagebuilder', '2016-12-13 17:26:59', 423, '0000-00-00 00:00:00', 0),
(15, 'screen-shot-2016-12-13-at-17.29.06', 'images/2016/12/13/screen-shot-2016-12-13-at-17.29.06.png', 'images/2016/12/13/_spmedia_thumbs/screen-shot-2016-12-13-at-17.29.06.png', 'screen-shot-2016-12-13-at-17.29.06', '', '', 'image', 'com_sppagebuilder', '2016-12-13 17:28:56', 423, '0000-00-00 00:00:00', 0),
(16, 'gcirclelogo', 'images/2016/12/13/gcirclelogo.png', 'images/2016/12/13/_spmedia_thumbs/gcirclelogo.png', 'gcirclelogo', '', '', 'image', 'com_sppagebuilder', '2016-12-13 19:40:53', 423, '0000-00-00 00:00:00', 0),
(17, 'myself', 'images/2016/12/13/myself.png', 'images/2016/12/13/_spmedia_thumbs/myself.png', 'myself', '', '', 'image', 'com_sppagebuilder', '2016-12-13 19:57:16', 423, '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_sppagebuilder`
--

CREATE TABLE IF NOT EXISTS `kts0j_sppagebuilder` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `kts0j_sppagebuilder`
--

INSERT INTO `kts0j_sppagebuilder` (`id`, `title`, `text`, `extension`, `extension_view`, `view_id`, `active`, `published`, `catid`, `access`, `ordering`, `created_on`, `created_by`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `og_title`, `og_image`, `og_description`, `language`, `hits`, `css`) VALUES
(1, 'Home', '[{"id":1481645289567,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"12","columns":[{"id":1481645289568,"class_name":"col-md-12","visibility":true,"settings":{},"addons":[{"id":1481645289571,"name":"image_content","visibility":true,"settings":{"admin_label":"","image":"images/2016/12/13/gcirclelogo.png","image_alignment":"left","title":"About Me","heading_selector":"h1","title_fontsize":"","title_lineheight":"","title_fontstyle":null,"title_letterspace":"0","title_fontweight":"","title_text_color":"","title_margin_top":"","title_margin_bottom":"","text":"<span style=\\"font-size: 10pt;\\">Hi, I''m Graham and i am a third year Creative Digital Media student in the Institute of Technology Blanchardstown. I am a highly motivated and ambitious individual, currently building on my knowledge and skills . i have excellent attention to detail, having this lets my come up with the best solution in all of my modules. i have a diversified skill set covering Videography, Audio/Video editing, Graphic Design and Photography. Im able to use own initiative and work as part of team under pressure to meet challenging deadlines and objectives. I have excellent inter-personal and digital communication skills, with a great determination to succeed in everything i do.</span>","button_text":"","button_fontstyle":null,"button_letterspace":"0","button_url":"","button_target":"","button_type":"default","button_appearance":"","button_background_color":"#444444","button_color":"#ffffff","button_background_color_hover":"#222222","button_color_hover":"#ffffff","button_size":"","button_shape":"rounded","button_block":"","button_icon":"","button_icon_position":"left","class":"","global_text_color":"","global_link_color":"","global_link_hover_color":"","global_use_background":"0","global_background_color":"","global_background_image":"","global_background_repeat":"no-repeat","global_background_size":"cover","global_background_attachment":"inherit","global_user_border":"0","global_border_width":"","global_border_color":"","global_boder_style":"none","global_border_radius":"","global_margin":"","global_padding":"","global_use_animation":"0","global_animation":"","global_animationduration":"300","global_animationdelay":"0","hidden_md":"0","hidden_sm":"0","hidden_xs":"0"}}]}]}]', 'com_sppagebuilder', 'page', 0, 0, 1, 0, 1, 0, '0000-00-00 00:00:00', 0, '2016-12-13 19:58:19', 423, 0, '0000-00-00 00:00:00', '', '', '', '*', 76, ''),
(2, 'Video', '[{"id":1481652503206,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"12","columns":[{"id":1481652503207,"class_name":"col-md-12","visibility":true,"settings":{},"addons":[{"id":1481652503210,"name":"text_block","visibility":true,"settings":{"admin_label":"","title":"Oblivious","heading_selector":"h3","title_fontsize":"","title_lineheight":"","title_fontstyle":null,"title_letterspace":"0","title_fontweight":"","title_text_color":"","title_margin_top":"","title_margin_bottom":"","text":"<h3 class=\\"widget-title\\"><span style=\\"font-size: 10pt;\\">This is a short film I made for my second year group project to raise aware of the homelessness crisis in Ireland My role in this project was to film and edit along with filling in as an extra in the film. This film was made my myself and my three classmates Ross Kelly, Zoe Gilligan and Kaylee Kinsella.</span></h3>","alignment":"sppb-text-left","class":"","global_text_color":"","global_link_color":"","global_link_hover_color":"","global_use_background":"0","global_background_color":"","global_background_image":"","global_background_repeat":"no-repeat","global_background_size":"cover","global_background_attachment":"inherit","global_user_border":"0","global_border_width":"","global_border_color":"","global_boder_style":"none","global_border_radius":"","global_margin":"","global_padding":"","global_use_animation":"0","global_animation":"","global_animationduration":"300","global_animationdelay":"0","hidden_md":"0","hidden_sm":"0","hidden_xs":"0"}}]}]},{"id":1481646392305,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"12","columns":[{"id":1481646392306,"class_name":"col-md-12","visibility":true,"settings":{},"addons":[{"id":1481646392309,"name":"video","visibility":true,"settings":{"admin_label":"","title":"","heading_selector":"h3","title_fontsize":"","title_lineheight":"","title_fontstyle":null,"title_letterspace":"0","title_fontweight":"","title_text_color":"","title_margin_top":"","title_margin_bottom":"","url":"https://www.vimeo.com/166437719","class":"","global_text_color":"","global_link_color":"","global_link_hover_color":"","global_use_background":"0","global_background_color":"","global_background_image":"","global_background_repeat":"no-repeat","global_background_size":"cover","global_background_attachment":"inherit","global_user_border":"0","global_border_width":"","global_border_color":"","global_boder_style":"none","global_border_radius":"","global_margin":"","global_padding":"","global_use_animation":"0","global_animation":"","global_animationduration":"300","global_animationdelay":"0","hidden_md":"0","hidden_sm":"0","hidden_xs":"0"}}]}]},{"id":1481652503214,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"12","columns":[{"id":1481652503215,"class_name":"col-md-12","visibility":true,"settings":{},"addons":[{"id":1481652503220,"name":"text_block","visibility":true,"settings":{"admin_label":"","title":"The Recession in Ireland","heading_selector":"h3","title_fontsize":"","title_lineheight":"","title_fontstyle":null,"title_letterspace":"0","title_fontweight":"","title_text_color":"","title_margin_top":"","title_margin_bottom":"","text":"<h3 class=\\"widget-title\\"><span style=\\"font-size: 10pt;\\">The Recession in Ireland was made my me and a classmate as part of an assignment in second year . The documentary is about what the recession was about how it affected Ireland. This short documentary contains two interviews of people affected by the rescission and you can hear a short description of their stories. The equipment used in this film was a Canon 70D DSLR camera and a full sound kit with a boom and a H6 recorder. It was also edited on Premier Pro.</span></h3>","alignment":"sppb-text-left","class":"","global_text_color":"","global_link_color":"","global_link_hover_color":"","global_use_background":"0","global_background_color":"","global_background_image":"","global_background_repeat":"no-repeat","global_background_size":"cover","global_background_attachment":"inherit","global_user_border":"0","global_border_width":"","global_border_color":"","global_boder_style":"none","global_border_radius":"","global_margin":"","global_padding":"","global_use_animation":"0","global_animation":"","global_animationduration":"300","global_animationdelay":"0","hidden_md":"0","hidden_sm":"0","hidden_xs":"0"}}]}]},{"id":1481646392310,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"12","columns":[{"id":1481646392311,"class_name":"col-md-12","visibility":true,"settings":{},"addons":[{"id":1481646392314,"name":"video","visibility":true,"settings":{"admin_label":"","title":"","heading_selector":"h3","title_fontsize":"","title_lineheight":"","title_fontstyle":null,"title_letterspace":"0","title_fontweight":"","title_text_color":"","title_margin_top":"","title_margin_bottom":"","url":"https://www.vimeo.com/165285598","class":"","global_text_color":"","global_link_color":"","global_link_hover_color":"","global_use_background":"0","global_background_color":"","global_background_image":"","global_background_repeat":"no-repeat","global_background_size":"cover","global_background_attachment":"inherit","global_user_border":"0","global_border_width":"","global_border_color":"","global_boder_style":"none","global_border_radius":"","global_margin":"","global_padding":"","global_use_animation":"0","global_animation":"","global_animationduration":"300","global_animationdelay":"0","hidden_md":"0","hidden_sm":"0","hidden_xs":"0"}}]}]},{"id":1481652503223,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"12","columns":[{"id":1481652503224,"class_name":"col-md-12","visibility":true,"settings":{},"addons":[{"id":1481652503227,"name":"text_block","visibility":true,"settings":{"admin_label":"","title":"Short Music video","heading_selector":"h3","title_fontsize":"","title_lineheight":"","title_fontstyle":null,"title_letterspace":"0","title_fontweight":"","title_text_color":"","title_margin_top":"","title_margin_bottom":"","text":"<h3 class=\\"widget-title\\"><span style=\\"font-size: 10pt;\\">This is a short music I made in first year as part of a one day lab for my module Digital Video. It was filmed on an phone 5 and edited using Premiere Pro</span></h3>","alignment":"sppb-text-left","class":"","global_text_color":"","global_link_color":"","global_link_hover_color":"","global_use_background":"0","global_background_color":"","global_background_image":"","global_background_repeat":"no-repeat","global_background_size":"cover","global_background_attachment":"inherit","global_user_border":"0","global_border_width":"","global_border_color":"","global_boder_style":"none","global_border_radius":"","global_margin":"","global_padding":"","global_use_animation":"0","global_animation":"","global_animationduration":"300","global_animationdelay":"0","hidden_md":"0","hidden_sm":"0","hidden_xs":"0"}}]}]},{"id":1481646392315,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"12","columns":[{"id":1481646392316,"class_name":"col-md-12","visibility":true,"settings":{},"addons":[{"id":1481646392319,"name":"video","visibility":true,"settings":{"admin_label":"Music Video","title":"","heading_selector":"h3","title_fontsize":"","title_lineheight":"","title_fontstyle":null,"title_letterspace":"0","title_fontweight":"","title_text_color":"","title_margin_top":"","title_margin_bottom":"","url":"https://www.vimeo.com/151154487","class":"","global_text_color":"","global_link_color":"","global_link_hover_color":"","global_use_background":"0","global_background_color":"","global_background_image":"","global_background_repeat":"no-repeat","global_background_size":"cover","global_background_attachment":"inherit","global_user_border":"0","global_border_width":"","global_border_color":"","global_boder_style":"none","global_border_radius":"","global_margin":"","global_padding":"","global_use_animation":"0","global_animation":"","global_animationduration":"300","global_animationdelay":"0","hidden_md":"0","hidden_sm":"0","hidden_xs":"0"}}]}]}]', 'com_sppagebuilder', 'page', 0, 0, 1, 0, 1, 0, '2016-12-13 16:28:31', 423, '2016-12-13 18:14:14', 423, 0, '0000-00-00 00:00:00', '', '', '', '*', 28, ''),
(3, 'Contact Me', '[{"id":1481658015952,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"6,6","columns":[{"id":1481658015953,"class_name":"col-md-6","visibility":true,"settings":{},"addons":[{"id":1481658015957,"name":"image","visibility":true,"settings":{"admin_label":"","title":"","heading_selector":"h3","title_fontsize":"","title_lineheight":"","title_fontstyle":null,"title_letterspace":"0","title_fontweight":"","title_text_color":"","title_margin_top":"","title_margin_bottom":"","image":"images/2016/12/13/screen-shot-2016-12-13-at-17.29.06.png","alt_text":"","position":"sppb-text-center","open_lightbox":"0","overlay_color":"rgba(119, 219, 31, 0.5)","link":"","target":"","class":"","global_text_color":"","global_link_color":"","global_link_hover_color":"","global_use_background":"0","global_background_color":"","global_background_image":"","global_background_repeat":"no-repeat","global_background_size":"cover","global_background_attachment":"inherit","global_user_border":"0","global_border_width":"","global_border_color":"","global_boder_style":"none","global_border_radius":"","global_margin":"","global_padding":"","global_use_animation":"0","global_animation":"","global_animationduration":"300","global_animationdelay":"0","hidden_md":"0","hidden_sm":"0","hidden_xs":"0"}}]},{"id":1481658015954,"class_name":"col-md-6","visibility":true,"settings":{},"addons":[{"id":1481648527135,"name":"text_block","visibility":true,"settings":{"admin_label":"","title":"","heading_selector":"h3","title_fontsize":"","title_lineheight":"","title_fontstyle":null,"title_letterspace":"0","title_fontweight":"","title_text_color":"","title_margin_top":"","title_margin_bottom":"","text":"<span style=\\"font-size: 18pt;\\"><em><strong>Contact Me</strong></em></span><br /><span style=\\"font-size: 18pt;\\"><strong><br />Email: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</strong><a href=\\"mailto:Murphy5711@hotmail.com\\">Murphy5711@hotmail.com</a><br /></span><br /><br /><span style=\\"font-size: 18pt;\\"><strong>Address: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </strong>Institute of Technology &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Blanchardstown, <br />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Dublin 15, Ireland<br /></span><br /><br /><span style=\\"font-size: 18pt;\\"><strong>Phone: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </strong>&nbsp; &nbsp;+353 (85) 8335704</span>","alignment":"sppb-text-center","class":"","global_text_color":"","global_link_color":"","global_link_hover_color":"","global_use_background":"0","global_background_color":"","global_background_image":"","global_background_repeat":"no-repeat","global_background_size":"cover","global_background_attachment":"inherit","global_user_border":"0","global_border_width":"","global_border_color":"","global_boder_style":"none","global_border_radius":"","global_margin":"","global_padding":"","global_use_animation":"0","global_animation":"","global_animationduration":"300","global_animationdelay":"0","hidden_md":"0","hidden_sm":"0","hidden_xs":"0"}}]}]},{"id":1481647592518,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"12","columns":[{"id":1481647592519,"class_name":"col-md-12","visibility":true,"settings":{},"addons":[]}]}]', 'com_sppagebuilder', 'page', 0, 0, 1, 0, 1, 0, '2016-12-13 16:48:39', 423, '2016-12-13 20:03:01', 423, 0, '0000-00-00 00:00:00', '', '', '', '*', 25, ''),
(4, 'Graphic Design', '[{"id":1481653025659,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"4,4,4","columns":[{"id":1481653025660,"class_name":"col-md-4","visibility":true,"settings":{},"addons":[]},{"id":1481659790793,"class_name":"col-md-4","visibility":true,"settings":{},"addons":[{"id":1481659790790,"name":"text_block","visibility":true,"settings":{"admin_label":"","title":"","heading_selector":"h3","title_fontsize":"","title_lineheight":"","title_fontstyle":null,"title_letterspace":"0","title_fontweight":"","title_text_color":"","title_margin_top":"","title_margin_bottom":"","text":"The below are some examples of my work. This have all been made using Adobe InDesign, Illustrator and Photoshop.","alignment":"sppb-text-left","class":"","global_text_color":"","global_link_color":"","global_link_hover_color":"","global_use_background":"0","global_background_color":"","global_background_image":"","global_background_repeat":"no-repeat","global_background_size":"cover","global_background_attachment":"inherit","global_user_border":"0","global_border_width":"","global_border_color":"","global_boder_style":"none","global_border_radius":"","global_margin":"","global_padding":"","global_use_animation":"0","global_animation":"","global_animationduration":"300","global_animationdelay":"0","hidden_md":"0","hidden_sm":"0","hidden_xs":"0"}}]},{"id":1481659790794,"class_name":"col-md-4","visibility":true,"settings":{},"addons":[]}]},{"id":1481648139799,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"12","columns":[{"id":1481648139800,"class_name":"col-md-12","visibility":true,"settings":{},"addons":[{"id":1481648139803,"name":"carousel","visibility":true,"settings":{"admin_label":"","autoplay":"0","controllers":"1","arrows":"1","alignment":"sppb-text-center","class":"","sp_carousel_item":[{"title":"","content":"","bg":"images/2016/12/13/screen-shot-2016-12-13-at-16.52.43.png","button_text":"","button_fontstyle":null,"button_letterspace":"0","button_url":"","button_target":"","button_type":"default","button_appearance":"","button_background_color":"#444444","button_color":"#ffffff","button_background_color_hover":"#222222","button_color_hover":"#ffffff","button_size":"","button_shape":"rounded","button_block":"","button_icon":"","button_icon_position":"left"},{"title":"","content":"Typeography Design ","bg":"images/2016/12/13/screen-shot-2016-12-13-at-16.52.20.png","button_text":"","button_fontstyle":null,"button_letterspace":"0","button_url":"","button_target":"","button_type":"default","button_appearance":"","button_background_color":"","button_color":"","button_background_color_hover":"","button_color_hover":"","button_size":"","button_shape":"rounded","button_block":"","button_icon":"","button_icon_position":"left"},{"title":"","content":"Storybook Character Design","bg":"images/2016/12/13/screen-shot-2016-12-13-at-16.52.30.png","button_text":"","button_fontstyle":null,"button_letterspace":"0","button_url":"","button_target":"","button_type":"default","button_appearance":"","button_background_color":"","button_color":"","button_background_color_hover":"","button_color_hover":"","button_size":"","button_shape":"rounded","button_block":"","button_icon":"","button_icon_position":"left"},{"title":"","content":"Company Rebrand Design","bg":"images/2016/12/13/screen-shot-2016-12-13-at-16.53.19.png","button_text":"","button_fontstyle":null,"button_letterspace":"0","button_url":"","button_target":"","button_type":"default","button_appearance":"","button_background_color":"","button_color":"","button_background_color_hover":"","button_color_hover":"","button_size":"","button_shape":"rounded","button_block":"","button_icon":"","button_icon_position":"left"},{"title":"","content":"Stensil Design","bg":"images/2016/12/13/screen-shot-2016-12-13-at-16.53.03.png","button_text":"","button_fontstyle":null,"button_letterspace":"0","button_url":"","button_target":"","button_type":"default","button_appearance":"","button_background_color":"","button_color":"","button_background_color_hover":"","button_color_hover":"","button_size":"","button_shape":"rounded","button_block":"","button_icon":"","button_icon_position":"left"},{"title":"","content":"Music mental Health Design","bg":"images/2016/12/13/screen-shot-2016-12-13-at-16.53.39.png","button_text":"","button_fontstyle":null,"button_letterspace":"0","button_url":"","button_target":"","button_type":"default","button_appearance":"","button_background_color":"","button_color":"","button_background_color_hover":"","button_color_hover":"","button_size":"","button_shape":"rounded","button_block":"","button_icon":"","button_icon_position":"left"},{"title":"","content":"Men in Black typeography Design","bg":"images/2016/12/13/screen-shot-2016-12-13-at-16.53.26.png","button_text":"","button_fontstyle":null,"button_letterspace":"0","button_url":"","button_target":"","button_type":"default","button_appearance":"","button_background_color":"","button_color":"","button_background_color_hover":"","button_color_hover":"","button_size":"","button_shape":"rounded","button_block":"","button_icon":"","button_icon_position":"left"},{"title":"","content":"Oblivious Design","bg":"images/2016/12/13/screen-shot-2016-12-13-at-16.53.55.png","button_text":"","button_fontstyle":null,"button_letterspace":"0","button_url":"","button_target":"","button_type":"default","button_appearance":"","button_background_color":"","button_color":"","button_background_color_hover":"","button_color_hover":"","button_size":"","button_shape":"rounded","button_block":"","button_icon":"","button_icon_position":"left"},{"title":"","content":"Bull Design","bg":"images/2016/12/13/screen-shot-2016-12-13-at-16.53.48.png","button_text":"","button_fontstyle":null,"button_letterspace":"0","button_url":"","button_target":"","button_type":"default","button_appearance":"","button_background_color":"","button_color":"","button_background_color_hover":"","button_color_hover":"","button_size":"","button_shape":"rounded","button_block":"","button_icon":"","button_icon_position":"left"}],"global_text_color":"","global_link_color":"","global_link_hover_color":"","global_use_background":"0","global_background_color":"","global_background_image":"","global_background_repeat":"no-repeat","global_background_size":"cover","global_background_attachment":"inherit","global_user_border":"0","global_border_width":"","global_border_color":"","global_boder_style":"none","global_border_radius":"","global_margin":"","global_padding":"","global_use_animation":"0","global_animation":"","global_animationduration":"300","global_animationdelay":"0","hidden_md":"0","hidden_sm":"0","hidden_xs":"0"}}]}]},{"id":1481659790786,"visibility":true,"collapse":false,"settings":{"padding":"50px 0px 50px 0px","margin":"0px 0px 0px 0px"},"layout":"12","columns":[{"id":1481659790787,"class_name":"col-md-12","visibility":true,"settings":{},"addons":[]}]}]', 'com_sppagebuilder', 'page', 0, 0, 1, 0, 1, 0, '0000-00-00 00:00:00', 0, '2016-12-13 20:15:09', 423, 0, '0000-00-00 00:00:00', '', '', '', '*', 19, '');

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_sppagebuilder_integrations`
--

CREATE TABLE IF NOT EXISTS `kts0j_sppagebuilder_integrations` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `description` mediumtext NOT NULL,
...
--
-- Table structure for table `kts0j_tags`
--

CREATE TABLE IF NOT EXISTS `kts0j_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `kts0j_tags`
--

INSERT INTO `kts0j_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 423, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_template_styles`
--

CREATE TABLE IF NOT EXISTS `kts0j_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `kts0j_template_styles`
--

INSERT INTO `kts0j_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.png","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'shaper_helix3', 0, '1', 'shaper_helix3 - Default', '{"preloader":"0","preloader_animation":"circle","preloader_bg":"#f5f5f5","preloader_tx":"#333333","goto_top":"0","sticky_header":"0","favicon":"images\\/Gcirclelogo.png","boxed_layout":"0","logo_type":"text","logo_position":"top1","logo_load_pos":"default","logo_image":"","logo_image_2x":"","mobile_logo":"","logo_text":"Graham Murphy","logo_slogan":"","body_bg_image":"","body_bg_repeat":"inherit","body_bg_size":"inherit","body_bg_attachment":"inherit","body_bg_position":"0 0","enabled_copyright":"1","copyright_position":"footer1","copyright_load_pos":"default","copyright":"The Graham Murphy","show_social_icons":"1","social_position":"top2","social_load_pos":"default","facebook":"https:\\/\\/www.facebook.com\\/gazayesa","twitter":"","googleplus":"","pinterest":"","linkedin":"https:\\/\\/www.linkedin.com\\/in\\/graham-murphy-57a55012a?trk=hp-identity-name","dribbble":"","behance":"","youtube":"","flickr":"","skype":"","vk":"","custom":"","enable_contactinfo":"1","contact_position":"top2","contact_phone":"+353 (85) 8335704","contact_mobile":"","contact_email":"Murphy5711@hotmail.com","contact_time":"","comingsoon_mode":"0","comingsoon_bg":"","comingsoon_logo":"","comingsoon_title":"Coming Soon Title","comingsoon_date":"05-10-2018","comingsoon_content":"Coming soon content","error_bg":"","error_logo":"","preset":"preset1","preset1_bg":"#ffffff","preset1_text":"#000000","preset1_major":"#26aae1","preset1_megabg":"#ffffff","preset1_megatx":"#333333","preset2_bg":"#ffffff","preset2_text":"#000000","preset2_major":"#3d449a","preset2_megabg":"#ffffff","preset2_megatx":"#333333","preset3_bg":"#ffffff","preset3_text":"#000000","preset3_major":"#2bb673","preset3_megabg":"#ffffff","preset3_megatx":"#333333","preset4_bg":"#ffffff","preset4_text":"#000000","preset4_major":"#eb4947","preset4_megabg":"#ffffff","preset4_megatx":"#333333","layoutlist":"default.json","layout":"[{\\"type\\":\\"row\\",\\"layout\\":\\"66\\",\\"settings\\":{\\"name\\":\\"Top Bar\\",\\"background_color\\":\\"#f5f5f5\\",\\"color\\":\\"#999999\\",\\"background_image\\":\\"\\",\\"background_repeat\\":\\"no-repeat\\",\\"background_size\\":\\"cover\\",\\"background_attachment\\":\\"fixed\\",\\"background_position\\":\\"0 0\\",\\"link_color\\":\\"\\",\\"link_hover_color\\":\\"\\",\\"hidden_xs\\":0,\\"hidden_sm\\":0,\\"hidden_md\\":0,\\"padding\\":\\"\\",\\"margin\\":\\"\\",\\"fluidrow\\":0,\\"custom_class\\":\\"\\",\\"bg_position\\":\\"contain\\",\\"bg_img_size\\":\\"cover\\",\\"bg_repeat\\":\\"no-repeat\\",\\"md_hidden\\":0,\\"ms_hidden\\":0,\\"xs_hidden\\":0,\\"text_color\\":\\"#ffffff\\",\\"bg_image\\":\\"images\\/powered_by.png\\",\\"bg_color\\":\\"#f02222\\"},\\"attr\\":[{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-6\\",\\"settings\\":{\\"column_type\\":0,\\"sortableitem\\":\\"[object Object]\\",\\"xs_hidden\\":0,\\"ms_hidden\\":0,\\"md_hidden\\":0,\\"custom_class\\":\\"\\",\\"name\\":\\"top1\\"}},{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-6\\",\\"settings\\":{\\"column_type\\":0,\\"sortableitem\\":\\"[object Object]\\",\\"name\\":\\"top2\\",\\"xs_hidden\\":0,\\"ms_hidden\\":0,\\"md_hidden\\":0,\\"custom_class\\":\\"\\"}}]},{\\"type\\":\\"row\\",\\"layout\\":\\"48\\",\\"settings\\":{\\"custom_class\\":\\"\\",\\"fluidrow\\":1,\\"margin\\":\\"\\",\\"padding\\":\\"\\",\\"hidden_md\\":0,\\"hidden_sm\\":0,\\"hidden_xs\\":0,\\"link_hover_color\\":\\"\\",\\"link_color\\":\\"\\",\\"background_image\\":\\"\\",\\"color\\":\\"\\",\\"background_color\\":\\"\\",\\"name\\":\\"Page Title\\"},\\"attr\\":[{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-4\\",\\"settings\\":{\\"column_type\\":0,\\"name\\":\\"menu\\",\\"hidden_xs\\":0,\\"hidden_sm\\":0,\\"hidden_md\\":0,\\"sm_col\\":\\"\\",\\"xs_col\\":\\"\\",\\"custom_class\\":\\"\\",\\"sortableitem\\":\\"[object Object]\\"}},{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-8\\",\\"settings\\":{}}]},{\\"type\\":\\"row\\",\\"layout\\":\\"363\\",\\"settings\\":{\\"custom_class\\":\\"\\",\\"md_hidden\\":0,\\"ms_hidden\\":0,\\"xs_hidden\\":0,\\"link_hover_color\\":\\"\\",\\"link_color\\":\\"\\",\\"text_color\\":\\"\\",\\"bg_image\\":\\"\\",\\"bg_color\\":\\"\\",\\"name\\":\\"Main Body\\"},\\"attr\\":[{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-3\\",\\"settings\\":{\\"column_type\\":0,\\"name\\":\\"left\\",\\"xs_hidden\\":0,\\"ms_hidden\\":0,\\"md_hidden\\":0,\\"custom_class\\":\\"custom-class\\",\\"sortableitem\\":\\"[object Object]\\"}},{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-6\\",\\"settings\\":{\\"column_type\\":1,\\"name\\":\\"\\",\\"custom_class\\":\\"\\",\\"md_hidden\\":0,\\"ms_hidden\\":0,\\"xs_hidden\\":0,\\"sortableitem\\":\\"[object Object]\\"}},{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-3\\",\\"settings\\":{\\"custom_class\\":\\"class2\\",\\"md_hidden\\":0,\\"ms_hidden\\":0,\\"xs_hidden\\":0,\\"name\\":\\"right\\",\\"column_type\\":0,\\"sortableitem\\":\\"[object Object]\\"}}]},{\\"type\\":\\"row\\",\\"layout\\":\\"3333\\",\\"settings\\":{\\"name\\":\\"Bottom\\",\\"background_color\\":\\"#f5f5f5\\",\\"color\\":\\"\\",\\"background_image\\":\\"\\",\\"link_color\\":\\"\\",\\"link_hover_color\\":\\"\\",\\"hidden_xs\\":0,\\"hidden_sm\\":0,\\"hidden_md\\":0,\\"padding\\":\\"100px 0px\\",\\"margin\\":\\"\\",\\"fluidrow\\":0,\\"custom_class\\":\\"\\"},\\"attr\\":[{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-3\\",\\"settings\\":{\\"column_type\\":0,\\"name\\":\\"bottom1\\",\\"hidden_xs\\":0,\\"hidden_sm\\":0,\\"hidden_md\\":0,\\"sm_col\\":\\"col-sm-6\\",\\"xs_col\\":\\"\\",\\"custom_class\\":\\"\\",\\"sortableitem\\":\\"[object Object]\\"}},{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-3\\",\\"settings\\":{\\"custom_class\\":\\"\\",\\"xs_col\\":\\"\\",\\"sm_col\\":\\"col-sm-6\\",\\"hidden_md\\":0,\\"hidden_sm\\":0,\\"hidden_xs\\":0,\\"name\\":\\"bottom2\\",\\"column_type\\":0}},{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-3\\",\\"settings\\":{\\"custom_class\\":\\"\\",\\"xs_col\\":\\"\\",\\"sm_col\\":\\"col-sm-6\\",\\"hidden_md\\":0,\\"hidden_sm\\":0,\\"hidden_xs\\":0,\\"name\\":\\"bottom3\\",\\"column_type\\":0}},{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-3\\",\\"settings\\":{\\"custom_class\\":\\"\\",\\"xs_col\\":\\"\\",\\"sm_col\\":\\"col-sm-6\\",\\"hidden_md\\":0,\\"hidden_sm\\":0,\\"hidden_xs\\":0,\\"name\\":\\"bottom4\\",\\"column_type\\":0}}]},{\\"type\\":\\"row\\",\\"layout\\":12,\\"settings\\":{\\"custom_class\\":\\"\\",\\"md_hidden\\":0,\\"ms_hidden\\":0,\\"xs_hidden\\":0,\\"link_hover_color\\":\\"\\",\\"link_color\\":\\"\\",\\"text_color\\":\\"\\",\\"bg_image\\":\\"\\",\\"bg_color\\":\\"\\",\\"name\\":\\"Footer\\"},\\"attr\\":[{\\"type\\":\\"sp_col\\",\\"className\\":\\"layout-column col-sm-12\\",\\"settings\\":{\\"xs_col\\":\\"\\",\\"sm_col\\":\\"\\",\\"hidden_md\\":0,\\"hidden_sm\\":0,\\"hidden_xs\\":0,\\"column_type\\":0,\\"name\\":\\"footer1\\",\\"xs_hidden\\":0,\\"ms_hidden\\":0,\\"md_hidden\\":0,\\"custom_class\\":\\"\\",\\"sortableitem\\":\\"[object Object]\\"}}]}]","menu":"nav","menu_type":"mega","dropdown_width":"","menu_animation":"menu-fade","offcanvas_animation":"default","enable_body_font":"1","body_font":"{\\"fontFamily\\":\\"Open Sans\\",\\"fontWeight\\":\\"300\\",\\"fontSubset\\":\\"latin\\",\\"fontSize\\":\\"\\"}","enable_h1_font":"1","h1_font":"{\\"fontFamily\\":\\"Open Sans\\",\\"fontWeight\\":\\"800\\",\\"fontSubset\\":\\"latin\\",\\"fontSize\\":\\"\\"}","enable_h2_font":"1","h2_font":"{\\"fontFamily\\":\\"Open Sans\\",\\"fontWeight\\":\\"600\\",\\"fontSubset\\":\\"latin\\",\\"fontSize\\":\\"\\"}","enable_h3_font":"1","h3_font":"{\\"fontFamily\\":\\"Open Sans\\",\\"fontWeight\\":\\"regular\\",\\"fontSubset\\":\\"latin\\",\\"fontSize\\":\\"\\"}","enable_h4_font":"1","h4_font":"{\\"fontFamily\\":\\"Open Sans\\",\\"fontWeight\\":\\"regular\\",\\"fontSubset\\":\\"latin\\",\\"fontSize\\":\\"\\"}","enable_h5_font":"1","h5_font":"{\\"fontFamily\\":\\"Open Sans\\",\\"fontWeight\\":\\"600\\",\\"fontSubset\\":\\"latin\\",\\"fontSize\\":\\"\\"}","enable_h6_font":"1","h6_font":"{\\"fontFamily\\":\\"Open Sans\\",\\"fontWeight\\":\\"600\\",\\"fontSubset\\":\\"latin\\",\\"fontSize\\":\\"\\"}","enable_navigation_font":"0","navigation_font":"{\\"fontFamily\\":\\"ABeeZee\\",\\"fontWeight\\":\\"regular\\",\\"fontSubset\\":\\"latin\\",\\"fontSize\\":\\"\\"}","enable_custom_font":"0","custom_font":"{\\"fontFamily\\":\\"ABeeZee\\",\\"fontWeight\\":\\"regular\\",\\"fontSubset\\":\\"latin\\",\\"fontSize\\":\\"\\"}","custom_font_selectors":"","before_head":"","before_body":"","custom_css":"","custom_js":"","compress_css":"0","compress_js":"0","exclude_js":"","lessoption":"0","show_post_format":"1","commenting_engine":"disabled","disqus_subdomain":"","disqus_devmode":"0","intensedebate_acc":"","fb_appID":"","fb_width":"500","fb_cpp":"10","comments_count":"0","social_share":"1","image_small":"0","image_small_size":"100X100","image_thumbnail":"1","image_thumbnail_size":"200X200","image_medium":"0","image_medium_size":"300X300","image_large":"0","image_large_size":"600X600","blog_list_image":"default","joomshaper_email":"","joomshaper_license_key":""}');

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_ucm_base`
--

CREATE TABLE IF NOT EXISTS `kts0j_ucm_base` (
...
--
-- Table structure for table `kts0j_ucm_content`
--

CREATE TABLE IF NOT EXISTS `kts0j_ucm_content` (
...
--
-- Table structure for table `kts0j_ucm_history`
--

CREATE TABLE IF NOT EXISTS `kts0j_ucm_history` (
...
--
-- Table structure for table `kts0j_update_sites`
--

CREATE TABLE IF NOT EXISTS `kts0j_update_sites` (
...
--
-- Dumping data for table `kts0j_update_sites`
--

INSERT INTO `kts0j_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1481658107, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1481658108, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1481658109, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1481658109, ''),
(5, 'Helix3 - Ajax', 'extension', 'http://www.joomshaper.com/updates/plg-ajax-helix3.xml', 1, 1481658110, ''),
(6, 'System - Helix3 Framework', 'extension', 'http://www.joomshaper.com/updates/plg-system-helix3.xml', 1, 1481658110, ''),
(7, 'shaper_helix3', 'extension', 'https://www.joomshaper.com/updates/shaper-helix3.xml', 1, 1481658110, ''),
(8, 'SP Page Builder', 'extension', 'http://www.joomshaper.com/updates/com-sp-page-builder-free.xml', 1, 1481658111, '');

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `kts0j_update_sites_extensions` (
...
--
-- Dumping data for table `kts0j_update_sites_extensions`
--

INSERT INTO `kts0j_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28),
...
--
-- Table structure for table `kts0j_updates`
--

CREATE TABLE IF NOT EXISTS `kts0j_updates` (
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Available Updates' AUTO_INCREMENT=74 ;

--
-- Dumping data for table `kts0j_updates`
--

INSERT INTO `kts0j_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
--
-- Table structure for table `kts0j_user_keys`
--

CREATE TABLE IF NOT EXISTS `kts0j_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `kts0j_user_notes`
--

CREATE TABLE IF NOT EXISTS `kts0j_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `kts0j_user_profiles`
--

CREATE TABLE IF NOT EXISTS `kts0j_user_profiles` (
...
--
-- Table structure for table `kts0j_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `kts0j_user_usergroup_map` (
...
--
-- Dumping data for table `kts0j_user_usergroup_map`
--

INSERT INTO `kts0j_user_usergroup_map` (`user_id`, `group_id`) VALUES
(423, 8);

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_usergroups`
--

CREATE TABLE IF NOT EXISTS `kts0j_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `kts0j_usergroups`
--

INSERT INTO `kts0j_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `kts0j_users`
--

CREATE TABLE IF NOT EXISTS `kts0j_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `kts0j_users`
--

INSERT INTO `kts0j_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(423, 'Super User', 'gazayesa', 'murphy5711@hotmail.com', '$2y$10$4mFkwqoA31t3UTsU7kkhReboTVWBkP7qQWuPsRTBwzbkRjy6.7GXW', 0, 1, '2016-12-13 14:55:49', '2016-12-13 19:26:43', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `kts0j_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `kts0j_utf8_conversion`
--

INSERT INTO `kts0j_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `kts0j_viewlevels`
--

CREATE TABLE IF NOT EXISTS `kts0j_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `kts0j_viewlevels`
--

INSERT INTO `kts0j_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
